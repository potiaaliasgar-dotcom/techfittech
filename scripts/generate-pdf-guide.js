...
async function generatePDF() {
  ...
  doc.font('Helvetica')
     .fontSize(10.5)
     .text('TechFit is the Reseller & Authorised Distributor (India) for world-class, premium strength, recovery, and cardio brands.', 50, y, { width: 495, lineGap: 4 });

  y += 50;
  const brands = [
    {
      title: 'BH Fitness — Commercial Gym Equipment (Spain)',
      desc: 'A world-leading commercial fitness brand with over 100 years of engineering heritage. Supplied by TechFit as Reseller (India), featuring unmatched ergonomics, biomechanics, and premium touchscreen displays (Movemia and Inertia lines).'
    },
    {
      title: 'Tunturi — Premium Strength & Wellness (Finland)',
      desc: 'Pioneers of European fitness and wellness since 1922. TechFit acts as Reseller (India) for Tunturi cardio and commercial strength stations representing absolute precision engineering, clean Scandinavian aesthetics, and commercial-grade durability.'
    },
    {
      title: 'Alteon — Clinical Biohacking & Recovery Suites',
      desc: 'Premium longevity and recovery equipment, supplied by TechFit as the Authorised Distributor (India). Includes monoplace hyperbaric oxygen chambers (HBOT), pure electric whole-body cryotherapy cabins, waterless dry float beds, and high-performance red light panels.'
    },
    {
      title: 'California Fitness — Heavy Selectorized Strength',
      desc: 'Maximum strength selectorized machines and plate-loaded stations, supplied by TechFit as Reseller (India). Engineered using thick-wall structural steel, heavy-duty pulleys, and precise biomechanical pivot angles for commercial power gyms.'
    }
  ];
