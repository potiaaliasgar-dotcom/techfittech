...
const rawJsonPath = '/Users/batman/Documents/Claude/Projects/Fitness Recall LLP/Alteon Site Build/data/products.json';
const dataPath = 'public/assets/alteon-data.js';
const galleryDir = 'public/assets/images/alteon/gallery';

let data = JSON.parse(fs.readFileSync(rawJsonPath, 'utf-8'));
...
console.log("Successfully updated alteon-data.js with new JSON and re-mapped galleries.");
