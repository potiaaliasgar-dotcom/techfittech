  ...
  <div class="footer-in">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <a href="https://share.google/IahWbxIMm9ywKR9qp" target="_blank" rel="noopener" class="footer-addr">309, Boat Hard Rd, Darukhana,<br>Byculla, Mumbai 400010</a>
      </div>
    </div>
...
`;
    ...
    const brandMeta = {
      ...
      'Tunturi': {
        ...
        sortOrder: ['SUBLIME', 'STERLING', 'PA', 'EVOLUTION', 'STRENGTH', 'FREE WEIGHTS', 'CARDIO'],
    ...
    <div class="contact-grid">
      <div class="contact-info">
        ...
        <a href="https://share.google/IahWbxIMm9ywKR9qp" target="_blank" rel="noopener" class="ci-link">
          <span class="ci-icon">📍</span>
          <div class="ci-text"><strong>TechFit Industrial</strong><br>309, Boat Hard Rd, Darukhana,<br>Byculla, Mumbai, Maharashtra 400010</div>
        </a>
        <br>
...
`;
  ...
  `;
    ...
    document.addEventListener('click', function (e) {
      ...
      if ((waLink || telLink || mailLink) && typeof gtag === 'function') {
        gtag('event', 'conversion', {
          'send_to': 'AW-17959203178/ObCTCPuJmv0bEOrizvNC',
          'value': 1.0,
          'currency': 'INR'
        });
        console.log('[TechFit] Google Ads conversion fired: ' + (waLink ? 'WhatsApp Click' : telLink ? 'Phone Call Click' : 'Email Click'));
      }
    });