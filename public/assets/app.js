...
`;
    ...
    const brandMeta = {
      ...
      'California Fitness': {
        ...
        badge: 'Commercial Grade · Equipment Partner',
        desc: 'California Fitness delivers premium commercial treadmills, ellipticals, bikes and a comprehensive strength range — organised into JF, CL, V, CF, HK, EG and PT series for every gym type and budget. Trusted by over 1,500 gyms across India. Supplied by TechFit as Equipment Partner in India.',
