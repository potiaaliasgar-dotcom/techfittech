...
function fireConversion(label, projectType = '') {
  ...
  console.log(`[TechFit] Google Ads conversion fired for: ${label} (${projectType})`);
}
...
${footer()}`;
    ...
    function submitEnq() {
      ...
      if (typeof gtag === 'function') {
        ...
        console.log('[TechFit] Google Ads conversion fired: WhatsApp Enquiry (Product)');
      }
  ...
  `;
    ...
    document.addEventListener('click', function (e) {
      ...
      if (waLink) {
        ...
        fireConversion(GAW_FORM_LABEL, 'Global Email Click');
      }
    });