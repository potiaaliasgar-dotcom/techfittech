...
async function submitEmbeddedQuote(projectType) {
  ...
  try {
    ...
    const navMap = {
      ...
      'bh-fitness': 'nl-products', 'tunturi': 'nl-products', 'bendis-pilates': 'nl-products', 'california-fitness': 'nl-products',
